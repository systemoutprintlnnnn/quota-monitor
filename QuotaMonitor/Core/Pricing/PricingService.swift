...
enum PricingSeed {
    ...
    private static let base: [PricingEntry] = [
        ...
        .init(modelId: "claude-mythos-5", displayName: "Claude Mythos 5",
              inputPricePerMillion: 10.00, cachedInputPricePerMillion: 1.00, outputPricePerMillion: 50.00,
              cacheCreationPricePerMillion: 12.50,
              effectiveModelId: "claude-mythos-5", isOfficial: false,
              note: "Limited availability. Seeded from public list price; refresh from LiteLLM for authoritative values.",
              sourceUrl: "https://www.anthropic.com/pricing"),
